...
class ExtracmakemodulesConan(ConanFile):
    ...
    def source(self):
        tools.get("https://invent.kde.org/frameworks/extra-cmake-modules/-/archive/v%s/extra-cmake-modules-v%s.zip" % (self.version, self.version))
        os.rename("extra-cmake-modules-v{}".format(self.version), self._source_subfolder)
